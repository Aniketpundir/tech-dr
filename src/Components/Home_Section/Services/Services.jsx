...
const allServices = [
    ...
    { title: 'Network & Wireless Set Up', desc: 'Eliminate dead zones and slow speeds. We design, configure, and secure reliable wired and wireless networks optimized for both modern homes and demanding small businesses.', img: networksetup, slug: 'network-wireless-set-up' },
    { title: 'Mobile Phone Email Set Up', desc: 'Stay connected on the go. We offer hassle-free, secure email account configuration across all major iOS and Android smartphones and tablets.', img: mobile, slug: 'mobile-phone-email-set-up' },
    { title: 'CCTV Setup & Servicing', desc: 'Protect what matters most. We specialize in the professional installation, configuration, and ongoing maintenance of high-definition CCTV security systems.', img: cctv, slug: 'cctv-setup-servicing' },
    { title: 'Servers Setup', desc: 'Empower your business infrastructure. We provide tailored server installations, secure data management, and continuous network administration for small to medium enterprises.', img: servers, slug: 'servers-setup' },
    { title: 'Data Recovery', desc: 'Accidentally deleted files or facing a failing hard drive? We offer secure, professional data recovery solutions to retrieve your invaluable documents, photos, and business data quickly.', img: data, slug: 'data-recovery' },
