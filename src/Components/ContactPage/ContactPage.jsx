    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" aria-hidden="true">
                ...
                <path d="M8 3.5 6.2 5.3M16 3.5l1.8 1.8" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
            </svg>
        ),
        content: (
            <p>
...
const socialLinks = [
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" aria-hidden="true">
                <path d="M14 8h3V4h-3a5 5 0 0 0-5 5v3H6v4h3v4h4v-8h3.2l.8-4H13V9a1 1 0 0 1 1-1Z" fill="currentColor" />
            </svg>
        )
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" aria-hidden="true">
                <path d="M6.5 8.5H3.8V20h2.7V8.5Zm.2-3.5a1.7 1.7 0 1 0-3.4 0 1.7 1.7 0 0 0 3.4 0ZM20.2 13.2c0-3.1-1.7-4.8-4.2-4.8-1.9 0-2.8 1.1-3.3 1.9V8.5H10V20h2.7v-6.2c0-1.6.3-3.1 2.3-3.1 2 0 2 1.8 2 3.2V20h2.7v-6.8Z" fill="currentColor" />
            </svg>
        )
    },
    {
        ...
        <section className="contact-page">
            <div className="contact-page-shell">
                <div className="contact-page-intro">
                    <span className="contact-page-kicker">Contact Us</span>
                    <h1>Let&apos;s make it easy to reach The Tech Dr.</h1>
                    <p>
                        Everything important is in one place: address, hours, phone,
                        social links, and a live Google Map so visitors can open directions in one tap.
                    </p>
                </div>
                ...
                <div className="contact-info-card">
                    ...
                    <div className="contact-info-block">
                        ...
                        <a href={mapLink} className="contact-map-link">
                ...
                <div className="contact-map-panel">
                    <a href={mapLink} className="contact-map-open">
                        Open in Maps
                        <svg viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M14 5h5v5M10 14 19 5M19 14v5h-5M5 10V5h5M5 19l6-6" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </a>
